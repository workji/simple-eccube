 ...
 */
class getOrderStatusControllerService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\Admin\Setting\Shop\OrderStatusController' shared autowired service.
     *
     * @return \Eccube\Controller\Admin\Setting\Shop\OrderStatusController
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\Admin\\Setting\\Shop\\OrderStatusController'] = $instance = new \Eccube\Controller\Admin\Setting\Shop\OrderStatusController(($container->privates['Eccube\\Repository\\Master\\OrderStatusRepository'] ?? $container->load('getOrderStatusRepositoryService')), ($container->privates['Eccube\\Repository\\Master\\OrderStatusColorRepository'] ?? $container->load('getOrderStatusColorRepositoryService')), ($container->privates['Eccube\\Repository\\Master\\CustomerOrderStatusRepository'] ?? $container->load('getCustomerOrderStatusRepositoryService')));
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Admin\\Setting\\Shop\\OrderStatusController', $container));
