 ...
 */
class getMaintenanceControllerService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\Admin\Content\MaintenanceController' shared autowired service.
     *
     * @return \Eccube\Controller\Admin\Content\MaintenanceController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Admin/Content/MaintenanceController.php';

        $container->services['Eccube\\Controller\\Admin\\Content\\MaintenanceController'] = $instance = new \Eccube\Controller\Admin\Content\MaintenanceController(($container->services['Eccube\\Service\\SystemService'] ?? $container->load('getSystemServiceService')));
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Admin\\Content\\MaintenanceController', $container));
