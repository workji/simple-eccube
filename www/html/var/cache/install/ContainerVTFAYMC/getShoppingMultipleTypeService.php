 ...
 */
class getShoppingMultipleTypeService extends Eccube_KernelInstallContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Eccube/Form/Type/ShoppingMultipleType.php';
