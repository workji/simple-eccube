 ...
 */
class getUserDataControllerService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\UserDataController' shared autowired service.
     *
     * @return \Eccube\Controller\UserDataController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/UserDataController.php';

        $container->services['Eccube\\Controller\\UserDataController'] = $instance = new \Eccube\Controller\UserDataController(($container->privates['Eccube\\Repository\\PageRepository'] ?? $container->load('getPageRepositoryService')), ($container->privates['Eccube\\Repository\\Master\\DeviceTypeRepository'] ?? $container->load('getDeviceTypeRepositoryService')));
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\UserDataController', $container));
