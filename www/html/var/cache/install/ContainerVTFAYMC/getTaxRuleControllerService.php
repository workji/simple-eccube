 ...
 */
class getTaxRuleControllerService extends Eccube_KernelInstallContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Admin/Setting/Shop/TaxRuleController.php';
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Admin\\Setting\\Shop\\TaxRuleController', $container));
