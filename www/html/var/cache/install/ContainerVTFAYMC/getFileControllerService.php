 ...
 */
class getFileControllerService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\Admin\Content\FileController' shared autowired service.
     *
     * @return \Eccube\Controller\Admin\Content\FileController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Admin/Content/FileController.php';

        $container->services['Eccube\\Controller\\Admin\\Content\\FileController'] = $instance = new \Eccube\Controller\Admin\Content\FileController();
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Admin\\Content\\FileController', $container));
