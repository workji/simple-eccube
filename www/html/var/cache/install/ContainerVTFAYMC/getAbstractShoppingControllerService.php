...
class getAbstractShoppingControllerService extends Eccube_KernelInstallContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.zpDQFkO'] ?? $container->load('get_ServiceLocator_ZpDQFkOService'))->withContext('Eccube\\Controller\\AbstractShoppingController', $container));
