 ...
 */
class getTagControllerService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\Admin\Product\TagController' shared autowired service.
     *
     * @return \Eccube\Controller\Admin\Product\TagController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Admin/Product/TagController.php';

        $container->services['Eccube\\Controller\\Admin\\Product\\TagController'] = $instance = new \Eccube\Controller\Admin\Product\TagController(($container->privates['Eccube\\Repository\\TagRepository'] ?? $container->load('getTagRepositoryService')));
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Admin\\Product\\TagController', $container));
