 ...
 */
class getSecurityControllerService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\Admin\Setting\System\SecurityController' shared autowired service.
     *
     * @return \Eccube\Controller\Admin\Setting\System\SecurityController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Admin/Setting/System/SecurityController.php';

        $container->services['Eccube\\Controller\\Admin\\Setting\\System\\SecurityController'] = $instance = new \Eccube\Controller\Admin\Setting\System\SecurityController(($container->services['.container.private.security.token_storage'] ?? $container->get_Container_Private_Security_TokenStorageService()));
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Admin\\Setting\\System\\SecurityController', $container));
