 ...
 */
class getClassCategoryRepositoryService extends Eccube_KernelInstallContainer
{
    /*
    ...
    {
        include_once \dirname(__DIR__, 4).'/src/Eccube/Repository/ClassCategoryRepository.php';
