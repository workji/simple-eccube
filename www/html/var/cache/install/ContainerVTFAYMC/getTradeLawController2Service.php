 ...
 */
class getTradeLawController2Service extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\TradeLawController' shared autowired service.
     *
     * @return \Eccube\Controller\TradeLawController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/TradeLawController.php';

        $container->services['Eccube\\Controller\\TradeLawController'] = $instance = new \Eccube\Controller\TradeLawController(($container->privates['Eccube\\Repository\\TradeLawRepository'] ?? $container->load('getTradeLawRepositoryService')));
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\TradeLawController', $container));
