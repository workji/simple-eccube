 ...
 */
class getJsControllerService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\Admin\Content\JsController' shared autowired service.
     *
     * @return \Eccube\Controller\Admin\Content\JsController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Admin/Content/JsController.php';

        $container->services['Eccube\\Controller\\Admin\\Content\\JsController'] = $instance = new \Eccube\Controller\Admin\Content\JsController();
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Admin\\Content\\JsController', $container));
