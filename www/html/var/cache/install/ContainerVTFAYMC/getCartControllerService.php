 ...
 */
class getCartControllerService extends Eccube_KernelInstallContainer
{
    /*
     * Gets the public 'Eccube\Controller\Block\CartController' shared autowired service.
     *
     * @return \Eccube\Controller\Block\CartController
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).'/vendor/symfony/framework-bundle/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/AbstractController.php';
        include_once \dirname(__DIR__, 4).'/src/Eccube/Controller/Block/CartController.php';

        $container->services['Eccube\\Controller\\Block\\CartController'] = $instance = new \Eccube\Controller\Block\CartController(($container->privates['Eccube\\Service\\CartService'] ?? $container->getCartServiceService()));
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Block\\CartController', $container));
