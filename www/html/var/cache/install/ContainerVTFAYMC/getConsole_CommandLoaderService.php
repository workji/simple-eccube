 ...
 */
class getConsole_CommandLoaderService extends Eccube_KernelInstallContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['console.command_loader'] = new \Symfony\Component\Console\CommandLoader\ContainerCommandLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'Eccube\\Command\\ComposerInstallCommand' => ['privates', 'Eccube\\Command\\ComposerInstallCommand', 'getComposerInstallCommandService', true],
            'Eccube\\Command\\ComposerRemoveCommand' => ['privates', 'Eccube\\Command\\ComposerRemoveCommand', 'getComposerRemoveCommandService', true],
            'Eccube\\Command\\ComposerRequireAlreadyInstalledPluginsCommand' => ['privates', 'Eccube\\Command\\ComposerRequireAlreadyInstalledPluginsCommand', 'getComposerRequireAlreadyInstalledPluginsCommandService', true],
            'Eccube\\Command\\ComposerRequireCommand' => ['privates', 'Eccube\\Command\\ComposerRequireCommand', 'getComposerRequireCommandService', true],
            'Eccube\\Command\\ComposerUpdateCommand' => ['privates', 'Eccube\\Command\\ComposerUpdateCommand', 'getComposerUpdateCommandService', true],
            'Eccube\\Command\\DeleteCartsCommand' => ['privates', 'Eccube\\Command\\DeleteCartsCommand', 'getDeleteCartsCommandService', true],
            'Eccube\\Command\\GenerateDummyDataCommand' => ['privates', 'Eccube\\Command\\GenerateDummyDataCommand', 'getGenerateDummyDataCommandService', true],
            'Eccube\\Command\\GenerateProxyCommand' => ['privates', 'Eccube\\Command\\GenerateProxyCommand', 'getGenerateProxyCommandService', true],
            'Eccube\\Command\\InstallerCommand' => ['privates', 'Eccube\\Command\\InstallerCommand', 'getInstallerCommandService', true],
            'Eccube\\Command\\LoadDataFixturesEccubeCommand' => ['privates', 'Eccube\\Command\\LoadDataFixturesEccubeCommand', 'getLoadDataFixturesEccubeCommandService', true],
            'Eccube\\Command\\PluginDisableCommand' => ['privates', 'Eccube\\Command\\PluginDisableCommand', 'getPluginDisableCommandService', true],
            'Eccube\\Command\\PluginEnableCommand' => ['privates', 'Eccube\\Command\\PluginEnableCommand', 'getPluginEnableCommandService', true],
            'Eccube\\Command\\PluginGenerateCommand' => ['privates', 'Eccube\\Command\\PluginGenerateCommand', 'getPluginGenerateCommandService', true],
            'Eccube\\Command\\PluginInstallCommand' => ['privates', 'Eccube\\Command\\PluginInstallCommand', 'getPluginInstallCommandService', true],
            'Eccube\\Command\\PluginSchemaUpdateCommand' => ['privates', 'Eccube\\Command\\PluginSchemaUpdateCommand', 'getPluginSchemaUpdateCommandService', true],
            'Eccube\\Command\\PluginUninstallCommand' => ['privates', 'Eccube\\Command\\PluginUninstallCommand', 'getPluginUninstallCommandService', true],
            'Eccube\\Command\\PluginUpdateCommand' => ['privates', 'Eccube\\Command\\PluginUpdateCommand', 'getPluginUpdateCommandService', true],
