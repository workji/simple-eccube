 ...
 */
class CustomerOrderStatus extends \Eccube\Entity\Master\CustomerOrderStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerOrderStatus $proxy) {
