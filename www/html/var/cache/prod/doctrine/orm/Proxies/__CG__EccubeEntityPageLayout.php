...
class PageLayout extends \Eccube\Entity\PageLayout implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\PageLayout' . "\0" . 'page_id', '' . "\0" . 'Eccube\\Entity\\PageLayout' . "\0" . 'layout_id', '' . "\0" . 'Eccube\\Entity\\PageLayout' . "\0" . 'sort_no', '' . "\0" . 'Eccube\\Entity\\PageLayout' . "\0" . 'Page', '' . "\0" . 'Eccube\\Entity\\PageLayout' . "\0" . 'Layout'];
        }
    ...
    public function getDeviceTypeId()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeviceTypeId', []);

        return parent::getDeviceTypeId();
    }
