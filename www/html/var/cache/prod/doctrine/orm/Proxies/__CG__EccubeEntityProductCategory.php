 ...
 */
class ProductCategory extends \Eccube\Entity\ProductCategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\ProductCategory' . "\0" . 'product_id', '' . "\0" . 'Eccube\\Entity\\ProductCategory' . "\0" . 'category_id', '' . "\0" . 'Eccube\\Entity\\ProductCategory' . "\0" . 'Product', '' . "\0" . 'Eccube\\Entity\\ProductCategory' . "\0" . 'Category'];
        }
