 ...
 */
class News extends \Eccube\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'publish_date', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'title', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'description', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'url', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'link_method', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'visible', '' . "\0" . 'Eccube\\Entity\\News' . "\0" . 'Creator'];
        }
    ...
    public function setLinkMethod($linkMethod)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLinkMethod', [$linkMethod]);

        return parent::setLinkMethod($linkMethod);
    }
    ...
    public function isLinkMethod()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isLinkMethod', []);

        return parent::isLinkMethod();
    }
