...
namespace Proxies\__CG__\Plugin\Recommend42\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class RecommendProduct extends \Plugin\Recommend42\Entity\RecommendProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\Recommend42\\Entity\\RecommendProduct' . "\0" . 'id', '' . "\0" . 'Plugin\\Recommend42\\Entity\\RecommendProduct' . "\0" . 'comment', '' . "\0" . 'Plugin\\Recommend42\\Entity\\RecommendProduct' . "\0" . 'sort_no', '' . "\0" . 'Plugin\\Recommend42\\Entity\\RecommendProduct' . "\0" . 'visible', '' . "\0" . 'Plugin\\Recommend42\\Entity\\RecommendProduct' . "\0" . 'create_date', '' . "\0" . 'Plugin\\Recommend42\\Entity\\RecommendProduct' . "\0" . 'update_date', '' . "\0" . 'Plugin\\Recommend42\\Entity\\RecommendProduct' . "\0" . 'Product'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RecommendProduct $proxy) {
