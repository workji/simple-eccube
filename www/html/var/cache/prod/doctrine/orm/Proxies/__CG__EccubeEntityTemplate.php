 ...
 */
class Template extends \Eccube\Entity\Template implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Template' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Template' . "\0" . 'code', '' . "\0" . 'Eccube\\Entity\\Template' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Template' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Template' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\Template' . "\0" . 'DeviceType'];
        }
    ...
    public function isDefaultTemplate()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isDefaultTemplate', []);

        return parent::isDefaultTemplate();
    }
