...
class Block extends \Eccube\Entity\Block implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'file_name', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'use_controller', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'deletable', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'BlockPositions', '' . "\0" . 'Eccube\\Entity\\Block' . "\0" . 'DeviceType'];
        }
    ...
    public function setUseController($useController)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUseController', [$useController]);

        return parent::setUseController($useController);
    }
    ...
    public function isUseController()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isUseController', []);

        return parent::isUseController();
    }
