 ...
 */
class ProductListOrderBy extends \Eccube\Entity\Master\ProductListOrderBy implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductListOrderBy $proxy) {
