 ...
 */
class CustomerFavoriteProduct extends \Eccube\Entity\CustomerFavoriteProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\CustomerFavoriteProduct' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\CustomerFavoriteProduct' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\CustomerFavoriteProduct' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\CustomerFavoriteProduct' . "\0" . 'Customer', '' . "\0" . 'Eccube\\Entity\\CustomerFavoriteProduct' . "\0" . 'Product'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerFavoriteProduct $proxy) {
