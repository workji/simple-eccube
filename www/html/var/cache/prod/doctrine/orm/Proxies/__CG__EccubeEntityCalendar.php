 ...
 */
class Calendar extends \Eccube\Entity\Calendar implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Calendar' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Calendar' . "\0" . 'title', '' . "\0" . 'Eccube\\Entity\\Calendar' . "\0" . 'holiday', '' . "\0" . 'Eccube\\Entity\\Calendar' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Calendar' . "\0" . 'update_date'];
        }
    ...
    public function isDefaultCalendar()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isDefaultCalendar', []);

        return parent::isDefaultCalendar();
    }
    ...
    public function setHoliday($holiday)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHoliday', [$holiday]);
    ...
    public function getHoliday()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getHoliday', []);
