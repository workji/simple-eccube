 ...
 */
class OrderStatusColor extends \Eccube\Entity\Master\OrderStatusColor implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (OrderStatusColor $proxy) {
