 ...
 */
class ProductTag extends \Eccube\Entity\ProductTag implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\ProductTag' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\ProductTag' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\ProductTag' . "\0" . 'Product', '' . "\0" . 'Eccube\\Entity\\ProductTag' . "\0" . 'Tag', '' . "\0" . 'Eccube\\Entity\\ProductTag' . "\0" . 'Creator'];
        }
