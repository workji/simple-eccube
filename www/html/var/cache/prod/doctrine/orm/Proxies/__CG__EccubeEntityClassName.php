...
class ClassName extends \Eccube\Entity\ClassName implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\ClassName' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\ClassName' . "\0" . 'backend_name', '' . "\0" . 'Eccube\\Entity\\ClassName' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\ClassName' . "\0" . 'sort_no', '' . "\0" . 'Eccube\\Entity\\ClassName' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\ClassName' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\ClassName' . "\0" . 'ClassCategories', '' . "\0" . 'Eccube\\Entity\\ClassName' . "\0" . 'Creator'];
        }
    ...
    public function addClassCategory(\Eccube\Entity\ClassCategory $classCategory)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addClassCategory', [$classCategory]);

        return parent::addClassCategory($classCategory);
    }
    ...
    public function removeClassCategory(\Eccube\Entity\ClassCategory $classCategory)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeClassCategory', [$classCategory]);

        return parent::removeClassCategory($classCategory);
    }
    ...
    public function getClassCategories()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getClassCategories', []);
