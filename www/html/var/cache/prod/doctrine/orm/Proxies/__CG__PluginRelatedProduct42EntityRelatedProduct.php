...
namespace Proxies\__CG__\Plugin\RelatedProduct42\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class RelatedProduct extends \Plugin\RelatedProduct42\Entity\RelatedProduct implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\RelatedProduct42\\Entity\\RelatedProduct' . "\0" . 'id', '' . "\0" . 'Plugin\\RelatedProduct42\\Entity\\RelatedProduct' . "\0" . 'content', '' . "\0" . 'Plugin\\RelatedProduct42\\Entity\\RelatedProduct' . "\0" . 'Product', '' . "\0" . 'Plugin\\RelatedProduct42\\Entity\\RelatedProduct' . "\0" . 'ChildProduct'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelatedProduct $proxy) {
    ...
    public function getChildProduct()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getChildProduct', []);

        return parent::getChildProduct();
    }
    ...
    public function setChildProduct(\Eccube\Entity\Product $Product = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setChildProduct', [$Product]);

        return parent::setChildProduct($Product);
    }
