...
namespace Proxies\__CG__\Plugin\MailMagazine42\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class MailMagazineSendHistory extends \Plugin\MailMagazine42\Entity\MailMagazineSendHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'id', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'mail_method', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'subject', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'body', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'html_body', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'send_count', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'complete_count', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'error_count', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'start_date', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'end_date', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'search_data', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'create_date', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'update_date', '' . "\0" . 'Plugin\\MailMagazine42\\Entity\\MailMagazineSendHistory' . "\0" . 'Creator'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (MailMagazineSendHistory $proxy) {
    ...
    public function setMailMethod($mailMethod)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMailMethod', [$mailMethod]);

        return parent::setMailMethod($mailMethod);
    }
    ...
    public function getMailMethod()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getMailMethod', []);

        return parent::getMailMethod();
    }
    ...
    public function setHtmlBody($html_body)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setHtmlBody', [$html_body]);

        return parent::setHtmlBody($html_body);
    }
    ...
    public function setSendCount($sendCount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSendCount', [$sendCount]);

        return parent::setSendCount($sendCount);
    }
    ...
    public function getSendCount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSendCount', []);

        return parent::getSendCount();
    }
    ...
    public function setCompleteCount($completeCount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCompleteCount', [$completeCount]);

        return parent::setCompleteCount($completeCount);
    }
    ...
    public function getCompleteCount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCompleteCount', []);

        return parent::getCompleteCount();
    }
    ...
    public function getErrorCount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getErrorCount', []);
    ...
    public function setErrorCount($errorCount)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setErrorCount', [$errorCount]);

        return parent::setErrorCount($errorCount);
    }
    ...
    public function setSearchData($searchData)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSearchData', [$searchData]);

        return parent::setSearchData($searchData);
    }
    ...
    public function getSearchData()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSearchData', []);
