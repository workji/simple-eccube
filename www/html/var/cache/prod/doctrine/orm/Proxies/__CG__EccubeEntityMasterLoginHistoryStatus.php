 ...
 */
class LoginHistoryStatus extends \Eccube\Entity\Master\LoginHistoryStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LoginHistoryStatus $proxy) {
