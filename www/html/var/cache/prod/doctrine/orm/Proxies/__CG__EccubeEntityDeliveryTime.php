 ...
 */
class DeliveryTime extends \Eccube\Entity\DeliveryTime implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\DeliveryTime' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\DeliveryTime' . "\0" . 'delivery_time', '' . "\0" . 'Eccube\\Entity\\DeliveryTime' . "\0" . 'Delivery', 'sort_no', '' . "\0" . 'Eccube\\Entity\\DeliveryTime' . "\0" . 'visible', '' . "\0" . 'Eccube\\Entity\\DeliveryTime' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\DeliveryTime' . "\0" . 'update_date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DeliveryTime $proxy) {
    ...
    public function setDeliveryTime($deliveryTime)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDeliveryTime', [$deliveryTime]);

        return parent::setDeliveryTime($deliveryTime);
    }
    ...
    public function getDeliveryTime()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDeliveryTime', []);

        return parent::getDeliveryTime();
    }
