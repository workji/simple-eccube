 ...
 */
class LoginHistory extends \Eccube\Entity\LoginHistory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\LoginHistory' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\LoginHistory' . "\0" . 'user_name', '' . "\0" . 'Eccube\\Entity\\LoginHistory' . "\0" . 'client_ip', '' . "\0" . 'Eccube\\Entity\\LoginHistory' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\LoginHistory' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\LoginHistory' . "\0" . 'Status', '' . "\0" . 'Eccube\\Entity\\LoginHistory' . "\0" . 'LoginUser'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LoginHistory $proxy) {
    ...
    public function setClientIp($clientIp)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setClientIp', [$clientIp]);

        return parent::setClientIp($clientIp);
    }
    ...
    public function getClientIp()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getClientIp', []);
