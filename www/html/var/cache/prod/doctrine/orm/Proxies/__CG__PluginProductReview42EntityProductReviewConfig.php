 ...
 */
class ProductReviewConfig extends \Plugin\ProductReview42\Entity\ProductReviewConfig implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\ProductReview42\\Entity\\ProductReviewConfig' . "\0" . 'id', '' . "\0" . 'Plugin\\ProductReview42\\Entity\\ProductReviewConfig' . "\0" . 'review_max', '' . "\0" . 'Plugin\\ProductReview42\\Entity\\ProductReviewConfig' . "\0" . 'CsvType', '' . "\0" . 'Plugin\\ProductReview42\\Entity\\ProductReviewConfig' . "\0" . 'create_date', '' . "\0" . 'Plugin\\ProductReview42\\Entity\\ProductReviewConfig' . "\0" . 'update_date'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductReviewConfig $proxy) {
    ...
    public function getReviewMax()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReviewMax', []);

        return parent::getReviewMax();
    }
    ...
    public function setReviewMax($max)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReviewMax', [$max]);

        return parent::setReviewMax($max);
    }
