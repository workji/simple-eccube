 ...
 */
class ProductReviewStatus extends \Plugin\ProductReview42\Entity\ProductReviewStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductReviewStatus $proxy) {
