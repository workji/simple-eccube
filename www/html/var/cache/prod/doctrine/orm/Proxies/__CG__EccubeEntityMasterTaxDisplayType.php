 ...
 */
class TaxDisplayType extends \Eccube\Entity\Master\TaxDisplayType implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TaxDisplayType $proxy) {
