 ...
 */
class ProductListMax extends \Eccube\Entity\Master\ProductListMax implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ProductListMax $proxy) {
