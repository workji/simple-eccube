 ...
 */
class DeliveryDuration extends \Eccube\Entity\DeliveryDuration implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\DeliveryDuration' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\DeliveryDuration' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\DeliveryDuration' . "\0" . 'duration', '' . "\0" . 'Eccube\\Entity\\DeliveryDuration' . "\0" . 'sort_no'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DeliveryDuration $proxy) {
