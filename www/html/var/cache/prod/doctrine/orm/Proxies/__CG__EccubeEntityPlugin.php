...
class Plugin extends \Eccube\Entity\Plugin implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'code', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'enabled', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'version', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'source', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'initialized', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\Plugin' . "\0" . 'update_date'];
        }
    ...
    public function isInitialized(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isInitialized', []);
    ...
    public function setInitialized(bool $initialized)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInitialized', [$initialized]);

        return parent::setInitialized($initialized);
    }
