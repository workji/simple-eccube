 ...
 */
class ProductStock extends \Eccube\Entity\ProductStock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\ProductStock' . "\0" . 'product_class_id', '' . "\0" . 'Eccube\\Entity\\ProductStock' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\ProductStock' . "\0" . 'stock', '' . "\0" . 'Eccube\\Entity\\ProductStock' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\ProductStock' . "\0" . 'update_date', '' . "\0" . 'Eccube\\Entity\\ProductStock' . "\0" . 'ProductClass', '' . "\0" . 'Eccube\\Entity\\ProductStock' . "\0" . 'Creator'];
        }
    ...
    public function setProductClassId($productClassId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProductClassId', [$productClassId]);

        return parent::setProductClassId($productClassId);
    }
