 ...
 */
class ProductImage extends \Eccube\Entity\ProductImage implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\ProductImage' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\ProductImage' . "\0" . 'file_name', '' . "\0" . 'Eccube\\Entity\\ProductImage' . "\0" . 'sort_no', '' . "\0" . 'Eccube\\Entity\\ProductImage' . "\0" . 'create_date', '' . "\0" . 'Eccube\\Entity\\ProductImage' . "\0" . 'Product', '' . "\0" . 'Eccube\\Entity\\ProductImage' . "\0" . 'Creator'];
        }
