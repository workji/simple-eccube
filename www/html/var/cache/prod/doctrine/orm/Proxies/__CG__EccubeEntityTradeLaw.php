 ...
 */
class TradeLaw extends \Eccube\Entity\TradeLaw implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\TradeLaw' . "\0" . 'id', '' . "\0" . 'Eccube\\Entity\\TradeLaw' . "\0" . 'name', '' . "\0" . 'Eccube\\Entity\\TradeLaw' . "\0" . 'description', '' . "\0" . 'Eccube\\Entity\\TradeLaw' . "\0" . 'sortNo', '' . "\0" . 'Eccube\\Entity\\TradeLaw' . "\0" . 'displayOrderScreen'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TradeLaw $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setId(int $id): \Eccube\Entity\TradeLaw
    {
     ...
     * {@inheritDoc}
     */
    public function setName(?string $name): \Eccube\Entity\TradeLaw
    {
     ...
     * {@inheritDoc}
     */
    public function setDescription(?string $description): \Eccube\Entity\TradeLaw
    {
     ...
     * {@inheritDoc}
     */
    public function setSortNo(int $sortNo): \Eccube\Entity\TradeLaw
    {
     ...
     * {@inheritDoc}
     */
    public function setDisplayOrderScreen(bool $displayOrderScreen): \Eccube\Entity\TradeLaw
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDisplayOrderScreen', [$displayOrderScreen]);

        return parent::setDisplayOrderScreen($displayOrderScreen);
    }
    ...
    public function isDisplayOrderScreen(): bool
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isDisplayOrderScreen', []);

        return parent::isDisplayOrderScreen();
    }
