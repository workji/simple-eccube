 ...
 */
class CouponDetail extends \Plugin\Coupon42\Entity\CouponDetail implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\Coupon42\\Entity\\CouponDetail' . "\0" . 'id', '' . "\0" . 'Plugin\\Coupon42\\Entity\\CouponDetail' . "\0" . 'coupon_type', '' . "\0" . 'Plugin\\Coupon42\\Entity\\CouponDetail' . "\0" . 'visible', '' . "\0" . 'Plugin\\Coupon42\\Entity\\CouponDetail' . "\0" . 'create_date', '' . "\0" . 'Plugin\\Coupon42\\Entity\\CouponDetail' . "\0" . 'update_date', '' . "\0" . 'Plugin\\Coupon42\\Entity\\CouponDetail' . "\0" . 'Coupon', '' . "\0" . 'Plugin\\Coupon42\\Entity\\CouponDetail' . "\0" . 'Product', '' . "\0" . 'Plugin\\Coupon42\\Entity\\CouponDetail' . "\0" . 'Category'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CouponDetail $proxy) {
     ...
     * {@inheritDoc}
     */
    public function setCoupon(\Plugin\Coupon42\Entity\Coupon $coupon)
    {
    ...
    public function getCategoryFullName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCategoryFullName', []);

        return parent::getCategoryFullName();
    }
