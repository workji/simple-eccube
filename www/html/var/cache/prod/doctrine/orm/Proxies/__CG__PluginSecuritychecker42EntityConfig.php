...
namespace Proxies\__CG__\Plugin\Securitychecker42\Entity;


/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Config extends \Plugin\Securitychecker42\Entity\Config implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Plugin\\Securitychecker42\\Entity\\Config' . "\0" . 'id', '' . "\0" . 'Plugin\\Securitychecker42\\Entity\\Config' . "\0" . 'check_result', '' . "\0" . 'Plugin\\Securitychecker42\\Entity\\Config' . "\0" . 'create_date', '' . "\0" . 'Plugin\\Securitychecker42\\Entity\\Config' . "\0" . 'update_date'];
        }
    ...
    public function setCheckResult($check_result)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCheckResult', [$check_result]);

        return parent::setCheckResult($check_result);
    }
    ...
    public function getCheckResult()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getCheckResult', []);

        return parent::getCheckResult();
    }
