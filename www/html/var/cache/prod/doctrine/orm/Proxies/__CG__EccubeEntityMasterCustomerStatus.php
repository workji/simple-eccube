 ...
 */
class CustomerStatus extends \Eccube\Entity\Master\CustomerStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CustomerStatus $proxy) {
