 ...
 */
class OrderStatus extends \Eccube\Entity\Master\OrderStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Eccube\\Entity\\Master\\OrderStatus' . "\0" . 'display_order_count', 'id', 'name', 'sort_no'];
        }
    ...
    public function isDisplayOrderCount()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isDisplayOrderCount', []);

        return parent::isDisplayOrderCount();
    }
    ...
    public function setDisplayOrderCount($display_order_count = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDisplayOrderCount', [$display_order_count]);

        return parent::setDisplayOrderCount($display_order_count);
    }
