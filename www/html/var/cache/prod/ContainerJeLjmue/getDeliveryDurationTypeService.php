 ...
 */
class getDeliveryDurationTypeService extends Eccube_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/Eccube/Form/Type/Master/DeliveryDurationType.php';
