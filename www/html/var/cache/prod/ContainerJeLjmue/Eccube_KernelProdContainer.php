...
class Eccube_KernelProdContainer extends Container
{
    ...
    protected function get_Container_Private_TwigService()
    {
        ...
        $f->addWorkflow(($this->services['.container.private.state_machine.order'] ?? $this->get_Container_Private_StateMachine_OrderService()), new \Symfony\Component\Workflow\SupportStrategy\InstanceOfSupportStrategy('Eccube\\Service\\OrderStateMachineContext'));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $e = \Doctrine\Common\Cache\Psr6\CacheAdapter::wrap($d);
        $f = new \Doctrine\Persistence\Mapping\Driver\MappingDriverChain();

        $g = new \Doctrine\ORM\Mapping\Driver\AttributeDriver([0 => (\dirname(__DIR__, 4).'/src/Eccube/Entity'), 1 => (\dirname(__DIR__, 4).'/vendor/league/oauth2-server-bundle/src/Entity')]);
        $h = ($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService());

        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/src/Eccube/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Api42/Entity')]);
        $j->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $k = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Coupon42/Entity')]);
        $k->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $l = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Plugin/MailMagazine42/Entity')]);
        $l->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $m = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Plugin/ProductReview42/Entity')]);
        $m->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $n = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Recommend42/Entity')]);
        $n->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $o = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Plugin/RelatedProduct42/Entity')]);
        $o->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $p = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Plugin/Securitychecker42/Entity')]);
        $p->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $q = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Plugin/SiteKit42/Entity')]);
        $q->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));

        $f->addDriver($g, 'Eccube\\Entity');
        $f->addDriver($g, 'League\\Bundle\\OAuth2ServerBundle\\Entity');
        $f->addDriver(new \League\Bundle\OAuth2ServerBundle\Persistence\Mapping\Driver('League\\Bundle\\OAuth2ServerBundle\\Model\\Client', true), 'League\\Bundle\\OAuth2ServerBundle\\Model');
        $f->addDriver($i, 'Eccube\\Entity');
        $f->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($h, [0 => (\dirname(__DIR__, 4).'/app/Customize/Entity')]), 'Customize\\Entity');
        $f->addDriver($j, 'Plugin\\Api42\\Entity');
        $f->addDriver($k, 'Plugin\\Coupon42\\Entity');
        $f->addDriver($l, 'Plugin\\MailMagazine42\\Entity');
        $f->addDriver($m, 'Plugin\\ProductReview42\\Entity');
        $f->addDriver($n, 'Plugin\\Recommend42\\Entity');
        $f->addDriver($o, 'Plugin\\RelatedProduct42\\Entity');
        $f->addDriver($p, 'Plugin\\Securitychecker42\\Entity');
        $f->addDriver($q, 'Plugin\\SiteKit42\\Entity');
        ...
        $a->setMetadataCache($e);
        $a->setQueryCache($e);
        $a->setResultCache($e);
        $a->setMetadataDriverImpl(new \Doctrine\Bundle\DoctrineBundle\Mapping\MappingDriver($f, new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.exception', [0 => function () {
            return ($this->privates['Eccube\\EventListener\\ExceptionListener'] ?? $this->load('getExceptionListenerService'));
    ...
    protected function getDebug_DebugHandlersListenerService()
    {
        ...
        $a->pushHandler(($this->privates['monolog.handler.main'] ?? $this->getMonolog_Handler_MainService()));
        $a->pushHandler(($this->privates['monolog.handler.e_user_deprecated_filter'] ?? $this->getMonolog_Handler_EUserDeprecatedFilterService()));
    ...
    {
        $this->privates['doctrine.app_cache_pool'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('SuvUs69B5f', 0, ($this->targetDir.''.'/pools/app'), ($this->privates['cache.default_marshaller'] ?? ($this->privates['cache.default_marshaller'] = new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, false))));
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/prod/admin.log'), 60, 100, true, NULL, false);
        ...
        return $this->privates['monolog.handler.admin'] = new \Monolog\Handler\FingersCrossedHandler($a, new \Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(400), 0, true, true, 200);
    }
     ...
     */
    protected function getMonolog_Handler_EUserDeprecatedFilterService()
    {
        return $this->privates['monolog.handler.e_user_deprecated_filter'] = new \Monolog\Handler\FilterHandler(new \Monolog\Handler\NullHandler(100, true), [0 => 200], 600, false);
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/prod/front.log'), 60, 100, true, NULL, false);
        $a->pushProcessor(($this->privates['monolog.processor.psr_log_message'] ?? ($this->privates['monolog.processor.psr_log_message'] = new \Monolog\Processor\PsrLogMessageProcessor())));
        $a->setFilenameFormat('{filename}-{date}', 'Y-m-d');
        $a->setFormatter(($this->privates['eccube.log.formatter.line'] ?? $this->getEccube_Log_Formatter_LineService()));

        return $this->privates['monolog.handler.front'] = new \Monolog\Handler\FingersCrossedHandler($a, new \Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(400), 0, true, true, 200);
    }
    ...
    {
        $a = new \Monolog\Handler\RotatingFileHandler((\dirname(__DIR__, 3).'/log/prod/site.log'), 60, 100, true, NULL, false);
        $a->pushProcessor(($this->privates['monolog.processor.psr_log_message'] ?? ($this->privates['monolog.processor.psr_log_message'] = new \Monolog\Processor\PsrLogMessageProcessor())));
        $a->setFilenameFormat('{filename}-{date}', 'Y-m-d');
        $a->setFormatter(($this->privates['eccube.log.formatter.line'] ?? $this->getEccube_Log_Formatter_LineService()));

        return $this->privates['monolog.handler.main'] = new \Monolog\Handler\FingersCrossedHandler($a, new \Monolog\Handler\FingersCrossed\ErrorLevelActivationStrategy(400), 0, true, true, 200);
    }
    ...
    protected function getSecurity_Firewall_MapService()
    {
        ...
        return $this->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () {
            ...
            yield 'security.firewall.map.context.admin' => ($this->privates['.security.request_matcher.rYcIECW'] ?? ($this->privates['.security.request_matcher.rYcIECW'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/')));
