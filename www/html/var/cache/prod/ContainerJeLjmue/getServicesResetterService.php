...
class getServicesResetterService extends Eccube_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->services['services_resetter'] = new \Symfony\Component\HttpKernel\DependencyInjection\ServicesResetter(new RewindableGenerator(function () use ($container) {
            ...
            return 0 + (int) (false) + (int) (false) + (int) (isset($container->privates['Monolog\\Processor\\UidProcessor'])) + (int) (isset($container->services['cache.app'])) + (int) (isset($container->services['cache.system'])) + (int) (isset($container->privates['cache.validator'])) + (int) (isset($container->privates['cache.serializer'])) + (int) (isset($container->privates['cache.annotations'])) + (int) (isset($container->privates['cache.property_info'])) + (int) (isset($container->privates['mailer.message_logger_listener'])) + (int) (isset($container->privates['debug.stopwatch'])) + (int) (isset($container->services['cache.rate_limiter'])) + (int) (isset($container->privates['rate_limiter.cache'])) + (int) (isset($container->privates['doctrine.app_cache_pool'])) + (int) (isset($container->privates['session_listener'])) + (int) (isset($container->privates['form.choice_list_factory.cached'])) + (int) (isset($container->services['cache.validator_expression_language'])) + (int) (isset($container->services['.container.private.security.token_storage'])) + (int) (isset($container->privates['cache.security_expression_language'])) + (int) (false) + (int) (isset($container->services['doctrine'])) + (int) (isset($container->privates['form.type.entity'])) + (int) (isset($container->privates['monolog.handler.e_user_deprecated_filter'])) + (int) (isset($container->privates['monolog.handler.main'])) + (int) (isset($container->privates['monolog.handler.front'])) + (int) (isset($container->privates['monolog.handler.admin'])) + (int) (isset($container->privates['monolog.handler.console'])) + (int) (isset($container->privates['twig.form.engine']));
        }), ['Eccube\\DataCollector\\EccubeDataCollector' => [0 => 'reset'], 'eccube.collector.core' => [0 => 'reset'], 'Monolog\\Processor\\UidProcessor' => [0 => 'reset'], 'cache.app' => [0 => 'reset'], 'cache.system' => [0 => 'reset'], 'cache.validator' => [0 => 'reset'], 'cache.serializer' => [0 => 'reset'], 'cache.annotations' => [0 => 'reset'], 'cache.property_info' => [0 => 'reset'], 'mailer.message_logger_listener' => [0 => 'reset'], 'debug.stopwatch' => [0 => 'reset'], 'cache.rate_limiter' => [0 => 'reset'], 'rate_limiter.cache' => [0 => 'reset'], 'doctrine.app_cache_pool' => [0 => 'reset'], 'session_listener' => [0 => 'reset'], 'form.choice_list_factory.cached' => [0 => 'reset'], 'cache.validator_expression_language' => [0 => 'reset'], 'security.token_storage' => [0 => 'disableUsageTracking', 1 => 'setToken'], 'cache.security_expression_language' => [0 => 'reset'], 'cache.security_token_verifier' => [0 => 'reset'], 'doctrine' => [0 => 'reset'], 'form.type.entity' => [0 => 'reset'], 'monolog.handler.e_user_deprecated_filter' => [0 => 'reset'], 'monolog.handler.main' => [0 => 'reset'], 'monolog.handler.front' => [0 => 'reset'], 'monolog.handler.admin' => [0 => 'reset'], 'monolog.handler.console' => [0 => 'reset'], 'twig.form.engine' => [0 => 'reset']]);
    }
}
