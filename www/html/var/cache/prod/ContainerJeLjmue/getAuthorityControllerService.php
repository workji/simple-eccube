 ...
 */
class getAuthorityControllerService extends Eccube_KernelProdContainer
{
    /*
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $container->services['Eccube\\Controller\\Admin\\Setting\\System\\AuthorityController'] = $instance = new \Eccube\Controller\Admin\Setting\System\AuthorityController(($container->privates['Eccube\\Repository\\AuthorityRoleRepository'] ?? $container->getAuthorityRoleRepositoryService()));
        ...
        $instance->setContainer(($container->privates['.service_locator.dkD0vsm'] ?? $container->load('get_ServiceLocator_DkD0vsmService'))->withContext('Eccube\\Controller\\Admin\\Setting\\System\\AuthorityController', $container));
